...
class GameWonFragment : Fragment() {
    ...
    private fun getShareIntent(): Intent{
        ...
        //intent.putExtra(Intent.EXTRA_TEXT, getString(R.string.share)+"${args.numCorrect}/${args.numQuestions}").setType("text/plain")
        var intent = ShareCompat.IntentBuilder.from(activity).setText("${args.numCorrect}/${args.numQuestions}").setType("text/plain").intent
        return intent
    }
