...
class GameViewModel : ViewModel(){
    ...
    private var _gameFinisher = MutableLiveData<Boolean>()
    val gameFinisher: LiveData<Boolean>
        get() = _gameFinisher
    ...
    init {
        Log.i("GameViewModel","creted")
        resetList()
        timer.start()
        nextWord()
        _score.value = 0
        _word.value = ""
        _gameFinisher.value = false
    }
